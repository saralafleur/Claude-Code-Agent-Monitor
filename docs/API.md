...
| `POST /api/project-plans/altitudes` `{project_id, units:[...]}` | PROJECT/STAKEHOLDER altitude synthesis for a client-held batch of `/pool` units |
