...
describe("GET /:id/trunk-drift", () => {
  ...
  it("R6: GET /:id/repos response shape unchanged", async () => {
    ...
    // return value, spread under project_id in the route handler). Updated at
    // the trunk-drift merge: master's ignored-repos feature added the
    // "ignoredRepos" key to this topology payload.
    const expectedKeys = [
      "detectedSiblings",
      "ignoredRepos",
      "nonRepoFolders",
