...
const schemas = {
  ...
  ValueUnitAltitude: {
    type: "object",
    description:
      "PROJECT/STAKEHOLDER altitude synthesis for one value-pool unit (server/lib/value-summary.js) — the layer above the pool's own GROUND fact.",
    properties: {
      project: { type: "string", description: "Short phrase naming what this unit is part of." },
      stakeholder: {
        type: "string",
        description: "One plain, jargon-free sentence a non-technical reader could act on.",
      },
...
const paths = {
  ...
  "/api/project-plans/altitudes": {
    post: {
      tags: ["Portfolio Plans"],
      operationId: "getValuePoolAltitudes",
      summary:
        "PROJECT/STAKEHOLDER altitude synthesis for a client-held batch of /pool units (never re-derives the pool itself)",
      requestBody: {
        required: true,
        content: {
          "application/json": {
            schema: {
              ...
              properties: {
                ...
                units: {
                  ...
                  items: {
                    type: "object",
                    required: ["unit_key", "value_source"],
                    properties: {
      ...
      responses: {
        200: {
          description:
            "Altitudes keyed by unit_key. A unit absent from the map means no altitude could be produced this round (LLM off/unavailable) — never an error.",
          content: {
            "application/json": {
              schema: {
                type: "object",
                properties: {
                  altitudes: {
                    type: "object",
                    additionalProperties: { $ref: "#/components/schemas/ValueUnitAltitude" },
                  },
                },
              },
            },
        ...
        400: {
          description: "project_id or units[] missing",
          content: { "application/json": { schema: errorRef } },
        },
      },
    },
